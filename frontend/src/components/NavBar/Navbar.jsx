...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        className={`overflow-x-hidden font-primary w-screen bg-navbar-background border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-navbar-background-dark ${
      ...
      >
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div
            ...
            id="mobile-menu-2"
          >
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-blue-900 md:text-white dark:bg-gray-800  dark:border-gray-700">
              <li>
                <Link
                  to="/"
