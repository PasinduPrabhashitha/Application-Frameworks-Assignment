...
const Home = () => {
  ...
  return (
    <div className="container w-screen min-h-screen">
      <div className="px-2 bg-cover flex items-center bg-no-repeat bg-center bg-[url('https://res.cloudinary.com/sliit45/image/upload/v1662725862/SPMAPP/Destinations/Temp-1920x1080_luw1nr.webp')] w-screen min-h-screen">
        <div className="text-white px-24">
          <h1 className="text-6xl font-bold font-primary">
            Infuse your next travel adventure <br /> with a touch of brilliance{" "}
            <br /> in Sri Lanka.
          </h1>
          <p className="text-xl font-primary">
            Immerse yourself in your destination with just a few clicks.
          </p>
        </div>
      </div>
