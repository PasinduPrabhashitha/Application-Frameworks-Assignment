...
const Homepage = () => {
  return (
    <div className="container w-screen min-h-screen">
      <div className=" h-[100vh] px-2 bg-cover flex items-center bg-no-repeat bg-center bg-[url('https://i.ibb.co/Dt0XVSW/travel-1749508.jpg')] w-screen">
        <div className="text-white px-24 w-4/5 flex flex-col gap-4">
          ...
          <p>
            ...
            same is taken care of by Soul Travels with a wide range of tour
            packages. Tour packages offered by Soul Travels are loved and
            considered by every traveler type for years now. Soul Travels is the
